...
namespace Soduko_Solver
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] testBoards = { matBase44, matBase, matBase1616,matBase2525,hardmat1616,hardMat2525,hardmat2525_2};
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                testMat = Tester.GenerateSudokuBoard(testMatFormatted, (int)(testMatFormatted.GetLength(0) * testMatFormatted.GetLength(0) * 0.99));
                sw2.Start();
                Test(testMat);
                sw2.Stop();
